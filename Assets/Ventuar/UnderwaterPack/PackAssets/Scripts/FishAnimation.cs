...
namespace LowPolyUnderwaterPack
{
    ...
    public class FishAnimation : MonoBehaviour
    {
        ...
        private void OnValidate()
        {
            ...
            // Get and apply fish material to objects with this component
            fishMatAsset = fishMatAsset != null ? fishMatAsset : (Material)AssetDatabase.LoadAssetAtPath("Assets/Ventuar/UnderwaterPack/PackAssets/Materials/Fish.mat", typeof(Material));
            
            if (rend.sharedMaterial != fishMatAsset)
                rend.sharedMaterial = fishMatAsset;
