...
namespace LowPolyUnderwaterPack
{
    ...
    public class PlantCoralAnimation : MonoBehaviour
    {
        ...
        private Material plantCoralMatAsset;
        ...
        public void OnValidate()
        {
            ...
            // Get and apply plantcoral material to objects with this component
            plantCoralMatAsset = plantCoralMatAsset != null ? plantCoralMatAsset : (Material)AssetDatabase.LoadAssetAtPath("Assets/Ventuar/UnderwaterPack/PackAssets/Materials/PlantCoral.mat", typeof(Material));
            
            if (rend.sharedMaterial != plantCoralMatAsset)
                rend.sharedMaterial = plantCoralMatAsset;
    ...
    public class PlantCoralAnimation_Editor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (generalFoldout)
            {
                ...
                if (showCoralProperties.boolValue == true)
                {
